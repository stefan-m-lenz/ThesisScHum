...
License & MIT & MIT & MIT & MIT & BSD-3 & GPL-3 \\ 
...
It also allows training binary RBMs and Gaussian RBMs as described by \cite{krizhevsky2009tinyimages} and evaluating them via estimating the likelihood with AIS.
...
The \apkg{darch} package uses the GPL-3 license \citep{gplv3}, which does not allow commercial derivations of the code.
