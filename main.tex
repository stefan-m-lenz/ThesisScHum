...
Plots from the monitoring data are produced by a separate package, \apkg{BoltzmannMachinesRPlots}\footnote{\url{https://github.com/stefan-m-lenz/BoltzmannMachinesRPlots}}.
...
\begin{lstlisting}[language=R,caption={Example code for remotely training a DBM and generating samples},label={lst:dsdbmexample},float]
