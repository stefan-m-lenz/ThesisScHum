...
\subsubsection{Experimental setup}
 ...
 single simulated data set, which is then distributed equally across sites.
...
\begin{figure}[h]
   ...
   \caption{Sketch of the experimental setup.
    ...
    These models generate synthetic data, which is combined into a single synthetic data set. 
