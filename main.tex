...
\begin{table}[h!]
\centering
\begin{tabular}{p{4.4cm} p{3.85cm} p{1.9cm} p{1.9cm}}
\hline
\emph{Feature} & \apkg{BoltzmannMachines} & \apkg{deepbelief} & \apkg{Boltzmann} \\
\hline
Language & Julia & Python & Julia \\
Bernoulli RBM & Yes & Yes & Yes  \\
Gaussian RBM (Hinton) & Yes & Yes & ? \\
Gaussian RBM (Cho) & Yes & No & ?  \\
...
\hline
\end{tabular}
\caption{\label{tab:FeatureOverview} Comparison of features between the
\apkg{BoltzmannMachines} (version 1.2), \apkg{Boltzmann} (version 0.7) and the implementation of \cite{theis2011deepbelief} (\apkg{deepbelief}). In the \apkg{Boltzmann} package, the formulas for the Gaussian are not defined and the implementation is wrong for both ways.}
\end{table}
%
%
%
