...
An alternative to importing a package in this way is to address the functions via their name as strings with the \inlinecode{juliaCall} function. 
...
The functions of the \apkg{BoltzmannMachines} package are sensitive concerning the argument types and it is required that the numbers have the correct types.
