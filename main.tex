...
The unnormalized probability of the hidden nodes in a Gaussian RBM with original parameterization (see formula (\ref{eqn:energyformulagbrbm}) can be calculated as
