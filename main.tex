...
Via Gibbs sampling \citep{gibbssamplingorig}, however, the term can be estimated. The Gibbs sampling algorithm for RBMs can be formulated as follows:
