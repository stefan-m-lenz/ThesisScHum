...
\begin{table}[h!]
\centering
\begin{tabular}{p{6.1cm} p{3cm} p{2.1cm} p{1.9cm} p{0.8cm} l}
%\hline
...
Although the mechanism for setting such a remote connection is not exposed in the \apkg{JuliaConnnectoR}, the potential for this is there.
...
Such a mechanism can be integrated to allow TODO

With this, it is also possible to use container technology
