...
These 30 locations spanning 50 variables form 30 different data sets, which are used in the evaluation.
...
From the 5008 samples, 500 samples are used in the training data sets, 100 in the test data sets, and 1000 in the validation data sets.
 ...
 data split equally across sites
 hyperparameter optimization RMSE of log odds
 training epochs ( up to 2000) and initialization of model parameters (15 different random seeds)
