...
In the UML diagram this composition of DBMs from vectors of RBMs is indicated by the UML composition relationship (line with filled diamond at the end).
...
TODO visiblepotential: As recommended by \citep{hinton_practical_2012} (section 3.2 there), the probabilities are used for the visible states in the last step of sampling in the model distribution.
