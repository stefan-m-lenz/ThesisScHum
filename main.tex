...
The results of \cite{nussberger_synthetic_2020} show that DBMs and VAEs are feasible generative models for genetic variant data, while the generative performance GANs is insufficient in settings of low sample size.
...
Its concept of multimodal DBMs  allows to train DBMs with partitioned layers conveniently.
It is based on using restricted Boltzmann machines (RBMs) as building blocks (see Figure \ref{mdbmimplasstack} on p.~\pageref{mdbmimplasstack}).
