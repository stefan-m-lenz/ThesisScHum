...
For training 
by addding noise and clipping the gradients \citep{abadi_deep_2016}.
...
There are also other weaknesses of $k$-anonymity, which aimed to be alleviated by proposed refinements \citep{machanavajjhala_l-diversity_2007, li_t-closeness:_2007}.

Common to all approaches is that they all rely on parameters that specify the level of privacy. These parameters cannot be determined absolutely. All these approaches for achieving privacy do not provide absolute certainty and merely serve as tools to minimize the disclosure risk.
