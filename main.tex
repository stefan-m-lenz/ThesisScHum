...
The \apkg{JuliaConnectoR}

\paragraph{Interrupting}\label{juliaconnectorinterrupting}

As training a deep learning model may take a long time and the hyperparameters have a strong influence on the execution times of an algorithm, it can be desired to stop the execution of a function call.
