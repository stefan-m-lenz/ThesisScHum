...
This means that a simply calculating the gradient and using standard gradient descent for optimization is technically not feasible in normal cases, as the number of summands grows exponentially with the number of nodes.
