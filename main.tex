...
\[
   \log p(v) \geq - E(v, \mu) - \log Z + \mathcal{H}(q)
\]
...
\end{align*}
For  $t \rightarrow \infty$, the series $\mu(t)$ converges to the value of $\mu$, which can be used for calculating the gradient for the lower bound.
This gradient can be calculated as 
