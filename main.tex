...
In listing \ref{lst:monfitdbm}, the different data sets that are to be used in monitoring are at first collected in a \inlinecode{DataDict} object and passed to the training function via the  \inlinecode{monitoringdata} argument.
