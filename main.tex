...
One class of unsupervised deep learning approaches are {\em generative models}, which able to generate new data according to a distribution that is learned from input data.
...
Hyperparameter is also a big challenge \citep{min_deep_2017}.
