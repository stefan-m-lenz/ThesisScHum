...
Configurations with lower energy have a higher probability of occurring.
...
In both cases, the information about the input is encapsulated in the parameters of the model, which influence the energy function, which in turn determines the probability of the activations in the network.
With this information, Boltzmann machines are then able to draw new samples and generate new data 
