...
\begin{lstlisting}[language=Julia,caption={Fitting a partitioned DBM},label={lst:partdbm}]
...
The \apkg{BoltzmannMachinesRPlots} package has implicitly been loaded as well. 
With the exported function \inlinecode{plotmonitoring}, the learning curves can be  displayed.
