...
This feature can also be used to validate the AIS implementation by testing its results against the exact calculated value in smaller models.
This is used in the test suite of the \apkg{BoltzmannMachines} package, which ensures the correctness of the implementation.
