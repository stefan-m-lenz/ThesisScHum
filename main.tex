...
TODO 
Inferences about individuals are nearly \citep{sweeney_k_anonymity_2012}.

$\epsilon$ differential privacy

More heuristic approaches are {\em k-anonymity} \citep{sweeney_k_anonymity_2012}
 aggregated data, ., l-diversity
The next approach for conducting privacy-preserving data across different sites also uses a pragmatic approach to minimize the risk of disclosure.
