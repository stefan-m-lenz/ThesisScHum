...
With respect also to the biomedical data sets of rather small sample sizes, the speed of Julia and its for gradual optimization was sufficient.
...
Another reason for Also, the training algorithms RBM and DBM  are automatic differentiation does not work with the Gibbs sampling algorithm.
 DBMs training fundamentally different from training other types of neural networks.
