...
\subsubsection{Training of restricted Boltzmann machines}
...
To calculate $Z$ exactly, this requires the 
This means that a simple gradient descent optimization technically not feasible in normal cases, as th. 
