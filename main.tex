...
Instead of using classical object oriented inheritance that Java or C++ offer, inheritance relationships can be implemented in Julia using {\em multiple dispatch} of the functions.
...
DBMs are modeled as arrays (i.e. one-dimensional vectors) of RBMs.
...
\begin{figure}
   \centering
   \includegraphics[scale=0.5,trim={4cm 4cm 3cm 2.4cm},clip]{images/BoltzmannMachinesDiagram.pdf}
