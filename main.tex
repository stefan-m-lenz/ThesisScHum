...
Analogously to equation (\ref{eqn:nablaresult}) for calculating the gradient of the log-likelihood in RBMs, this gradient can be calculated as 
\begin{align*}
...
The training procedure can be generalized as follows:
...
\subsection{General methods for deep learning}
TODO Blick über den Tellerrand von DBMs hinaus
...
TODO TensorFlow, Flux, Pytorch etc.
