...
It is also possible to produce plots already during the training by utilizing R callback functions (see \ref{juliaconnectorcallbacks}).
...
The function \inlinecode{plotValVsEpoch} (lines 8-18 in Listing \ref{callbackexample}) evaluates the model and adds the value of the evaluation to the plot in subsequent epochs.
...
This is used later in TODO DataSHIELD vorgreifen.
