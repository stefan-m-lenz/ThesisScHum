...
Therefore, the decision for creating a new software implementation of the algorithms was made.
%TODO warum rbm code nicht benutzt
...
(The archived status means that it failed checks in newer versions of R and that it cannot be installed directly any more.)
%TODO darch: DataSHIELD. muss ich hier mit performance argumentieren?
