...
\hline
Language & Julia & Python & Julia & ? & ? & ? \\
Bernoulli RBM & Yes & Yes & Yes  & ? & ? & ? \\
Gaussian RBM (Hinton) & Yes & Yes & No (*) & ? & ? & ? \\
Gaussian RBM (Cho) & Yes & No & No (*)  & ? & ? & ? \\
DBN training & Yes & Yes & Yes & ? & ? & ? \\
DBM training & Yes & No & No & ? & ? & ? \\
Partitioned DBM & Yes & No & No & ? & ? & ? \\
Multimodal DBM & Yes & No & No & ? & ? & ? \\
AIS for RBMs & Yes & Yes & No & ? & ? & ? \\
AIS for DBMs & Yes & No & No & ? & ? & ? \\
\hline
\end{tabular}
\caption{\label{tab:FeatureOverview} Comparison of features between the software packages
\apkg{BoltzmannMachines} (version 1.2), \apkg{Boltzmann} (version 0.7) and the implementation of \cite{theis2011deepbelief} (\apkg{deepbelief}). 
...
%
%
\paragraph{Julia implementations}
