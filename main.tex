...
The well-documented concept for the mapping between Julia and R types and objects (see \ref{translatejuliar} and Appendix \ref{JuliaConnectoRDoku}, p.~\pageref{juliaconnectordokutypetranslation}ff.) further helps to create cross-language code.
