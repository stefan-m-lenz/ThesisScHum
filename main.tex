...
In DataSHIELD only known users are allowed to conduct analyses and their activity is be logged to prevent analyses with malicious intent.
...
The advantage of the proportion of overfitting is that it can be judged independently of ther 
