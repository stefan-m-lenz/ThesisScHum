\subsection*{AbstractOptimizer} \phantomsection \label{bms_AbstractOptimizer}
...
%======================================================
\subsection*{AbstractRBM} \phantomsection \label{bms_AbstractRBM}
Abstract supertype for all RBMs 

\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{AbstractTrainLayer} \phantomsection \label{bms_AbstractTrainLayer}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{BernoulliGaussianRBM} \phantomsection \label{bms_BernoulliGaussianRBM}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{BernoulliRBM} \phantomsection \label{bms_BernoulliRBM}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{Binomial2BernoulliRBM} \phantomsection \label{bms_Binomial2BernoulliRBM}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{DataDict} \phantomsection \label{bms_DataDict}
A dictionary containing names of data sets as keys and the data sets (matrices with samples in rows) as values.

\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{GaussianBernoulliRBM} \phantomsection \label{bms_GaussianBernoulliRBM}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{GaussianBernoulliRBM2} \phantomsection \label{bms_GaussianBernoulliRBM2}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{LoglikelihoodOptimizer} \phantomsection \label{bms_LoglikelihoodOptimizer}
Implements the \texttt{AbstractOptimizer} interface for optimizing the loglikelihood with stochastic gradient descent.

\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{Monitor} \phantomsection \label{bms_Monitor}
A vector for collecting \texttt{MonitoringItem}s during training.

\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{MonitoringItem} \phantomsection \label{bms_MonitoringItem}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{Particles} \phantomsection \label{bms_Particles}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{PartitionedRBM} \phantomsection \label{bms_PartitionedRBM}
\begin{verbatim}
PartitionedRBM(rbms)
\end{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{TrainLayer} \phantomsection \label{bms_TrainLayer}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{TrainPartitionedLayer} \phantomsection \label{bms_TrainPartitionedLayer}
Encapsulates a vector of \texttt{TrainLayer} objects for training a partitioned layer.

\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{aislogimpweights} \phantomsection \label{bms_aislogimpweights}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{aisprecision} \phantomsection \label{bms_aisprecision}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{aisstandarddeviation} \phantomsection \label{bms_aisstandarddeviation}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{barsandstripes} \phantomsection \label{bms_barsandstripes}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{computegradient!} \phantomsection \label{bms_computegradient!}
\begin{verbatim}
...
For RBMs (excluding PartitionedRBMs), this means saving the gradient in a RBM of the same type in the field \texttt{optimizer.\allowbreak gradient}.

\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{crossvalidation} \phantomsection \label{bms_crossvalidation}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{empiricalloglikelihood} \phantomsection \label{bms_empiricalloglikelihood}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{energy} \phantomsection \label{bms_energy}
\begin{verbatim}
energy(rbm, v, h)
\end{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{exactloglikelihood} \phantomsection \label{bms_exactloglikelihood}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{exactlogpartitionfunction} \phantomsection \label{bms_exactlogpartitionfunction}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{fitdbm} \phantomsection \label{bms_fitdbm}
\begin{verbatim}
fitdbm(x; ...)
\end{verbatim}
Fits a (multimodal) DBM to the data set \texttt{x}. The procedure consists of two parts: First a stack of RBMs is pretrained in a greedy layerwise manner (see \texttt{stackrbms(x)}). Then the weights of all layers are jointly trained using the general Boltzmann Machine learning procedure (see \texttt{traindbm!\allowbreak (dbm,x)}).
...
\item \texttt{optimizer}\slash \texttt{optimizers}: an optimizer or a vector of optimizers for each epoch  (see \texttt{AbstractOptimizer}) used for fine-tuning.
...
\item \texttt{optimizer}\slash \texttt{optimizers}: an object of type \texttt{AbstractOptimizer} or a vector of  them for each epoch. If specified, the optimization is performed as implemented  by the given optimizer type. By default, the \texttt{LoglikelihoodOptimizer}  with the \texttt{learningrate}\slash \texttt{learningrates} and \texttt{sdlearningrate}\slash \texttt{sdlearningrates}  is used. For other types of optimizers, the learning rates must be specified  in the \texttt{optimizer}. For more information on how to write your own optimizer,  see \texttt{AbstractOptimizer}.
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{freeenergy} \phantomsection \label{bms_freeenergy}
\begin{verbatim}
freeenergy(rbm, x)
\end{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{gibbssample!} \phantomsection \label{bms_gibbssample!}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{gibbssamplecond!} \phantomsection \label{bms_gibbssamplecond!}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{hiddeninput} \phantomsection \label{bms_hiddeninput}
\begin{verbatim}
hiddeninput(rbm, v)
\end{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{hiddenpotential} \phantomsection \label{bms_hiddenpotential}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{initialized} \phantomsection \label{bms_initialized}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{initparticles} \phantomsection \label{bms_initparticles}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{initrbm} \phantomsection \label{bms_initrbm}
\begin{verbatim}
initrbm(x, nhidden)
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{intensities} \phantomsection \label{bms_intensities}
\begin{verbatim}
intensities(x)
intensities(x, q1)
intensities(x, q1, q2)
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{intensities\_decode} \phantomsection \label{bms_intensities_decode}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{intensities\_encode} \phantomsection \label{bms_intensities_encode}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{joindbms} \phantomsection \label{bms_joindbms}
\begin{verbatim}
joindbms(dbms)
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{joinrbms} \phantomsection \label{bms_joinrbms}
\begin{verbatim}
joinrbms(rbms)
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{loglikelihood} \phantomsection \label{bms_loglikelihood}
\begin{verbatim}
loglikelihood(rbm, x)
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{logpartitionfunction} \phantomsection \label{bms_logpartitionfunction}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{logpartitionfunctionzeroweights} \phantomsection \label{bms_logpartitionfunctionzeroweights}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{logproblowerbound} \phantomsection \label{bms_logproblowerbound}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{meanfield} \phantomsection \label{bms_meanfield}
\begin{verbatim}
meanfield(dbm, x)
meanfield(dbm, x, eps)
\end{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{monitored\_fitdbm} \phantomsection \label{bms_monitored_fitdbm}
\begin{verbatim}
monitored_fitdbm(x; ...)
\end{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{monitored\_fitrbm} \phantomsection \label{bms_monitored_fitrbm}
\begin{verbatim}
monitored_fitrbm(x; ...)
\end{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{monitored\_stackrbms} \phantomsection \label{bms_monitored_stackrbms}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{monitored\_traindbm!} \phantomsection \label{bms_monitored_traindbm!}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{monitorexactloglikelihood!} \phantomsection \label{bms_monitorexactloglikelihood!}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{monitorfreeenergy!} \phantomsection \label{bms_monitorfreeenergy!}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{monitorloglikelihood!} \phantomsection \label{bms_monitorloglikelihood!}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{monitorlogproblowerbound!} \phantomsection \label{bms_monitorlogproblowerbound!}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{monitorreconstructionerror!} \phantomsection \label{bms_monitorreconstructionerror!}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{monitorweightsnorm!} \phantomsection \label{bms_monitorweightsnorm!}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{oneornone\_decode} \phantomsection \label{bms_oneornone_decode}
\begin{verbatim}
oneornone_decode(x, categories)
\end{verbatim}
Returns a dataset such that \texttt{x .\allowbreak == oneornone\_decode(oneornone\_encode(x, categories), categories)}.

For more, see \texttt{oneornone\_encode}.

\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{oneornone\_encode} \phantomsection \label{bms_oneornone_encode}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{propagateforward} \phantomsection \label{bms_propagateforward}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{reconstructionerror} \phantomsection \label{bms_reconstructionerror}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{samplehidden} \phantomsection \label{bms_samplehidden}
\begin{verbatim}
samplehidden(rbm, v)
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{sampleparticles} \phantomsection \label{bms_sampleparticles}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{samples} \phantomsection \label{bms_samples}
\begin{verbatim}
samples(bm, nsamples; ...)
\end{verbatim}
...
\item \texttt{conditions}: \texttt{Vector\{Pair\{Int,Float64\}\}}, containing pairs of variables and their values that are to be conditioned on. E. g. \texttt{[1 => 1.0, 3 => 0.\allowbreak 0]}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{samplevisible} \phantomsection \label{bms_samplevisible}
\begin{verbatim}
samplevisible(rbm, h)
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{splitdata} \phantomsection \label{bms_splitdata}
\begin{verbatim}
splitdata(x, ratio)
\end{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{stackrbms} \phantomsection \label{bms_stackrbms}
\begin{verbatim}
stackrbms(x; ...)
\end{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{traindbm!} \phantomsection \label{bms_traindbm!}
\begin{verbatim}
traindbm!(dbm, x; ...)
\end{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{trainrbm!} \phantomsection \label{bms_trainrbm!}
\begin{verbatim}
trainrbm!(rbm, x)
\end{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{updateparameters!} \phantomsection \label{bms_updateparameters!}
\begin{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{visibleinput} \phantomsection \label{bms_visibleinput}
\begin{verbatim}
visibleinput(rbm, h)
\end{verbatim}
...
\noindent\rule{\textwidth}{1pt}
%======================================================
\subsection*{visiblepotential} \phantomsection \label{bms_visiblepotential}
\begin{verbatim}
